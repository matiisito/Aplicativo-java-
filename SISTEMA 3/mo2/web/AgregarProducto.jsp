<%-- 
    ...
    Created on : 21-10-2017, 20:46:19
    Author     : Sergio
--%>
...
<html>
    ...
    <body>
        ...
        <form class="col-md-6" action="RegistrarProducto" method="POST" enctype='multipart/form-data'>
                    ...
                    <c:forEach var="r" items="${LstRubros}">
                        ...
                        <font color="red">
                                    <c:out value="${mapMensajes['rubro']}"/>
                                        ...
                                        <tr>
                        <td><input class="btn btn-primary" type="submit" value="Registrar Producto" /></td>
