<%-- 
    ...
    Created on : 27-oct-2017, 19:54:58
    Author     : gus
--%>
...
<html>
    ...
    <body>
        ...
        <form class="col-md-6" action="ModificarOferta" method="POST" >
        <h3>Editar Oferta</h3>           
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="txtprecio_oferta" value="${oferta.getPrecio_oferta() == 0 ? '' : oferta.getPrecio_oferta()}" />
                            <font color="red">
