...
public class ConsultarOferta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ConsultarOferta</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ConsultarOferta at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/EditarOferta.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        OfertaDAO o = new OfertaDAO();
        OfertaDTO oferta = o.leer(id);
        System.out.println("el precio oferta es:"+oferta.getPrecio_oferta());
        request.setAttribute("oferta", oferta);
        request.getRequestDispatcher("/EditarOferta.jsp").forward(request, response);
    }
