 ...
 * @author gus
 */
public class ValorarOferta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<ValoracionDTO> valoraciones = v.leerTodosFiltrado(id);
        System.out.println("el precio oferta es:"+oferta.getPrecio_oferta());
        request.setAttribute("valoraciones", valoraciones);
        request.setAttribute("oferta", oferta);
        request.getRequestDispatcher("/ValorarOferta.jsp").forward(request, response);
